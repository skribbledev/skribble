...
export interface SkribbleConfig {
  ...
  /**
   * Add css variables make sure they are correctly cased `--kebab-case`.
   */
...
/**
 * An object of named colors which can be used within the theme.
 */
...
/**
 * This interface can be extended to include new palette names.
 */
export interface ColorPaletteNames {}
