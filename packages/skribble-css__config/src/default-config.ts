...
export const DEFAULT_CONFIG: SkribbleConfig = {
  ...
  atoms: [
    ...
    },
    {
      styleRules: ['animate'],
      keyframes: ['spin'],
      values: { spin: 'spin var(--default-animation-duration) linear infinite' },
    },
    {
      styleRules: ['animate'],
      keyframes: ['ping'],
      values: {
        ping: 'ping var(--default-animation-duration) cubic-bezier(0, 0, 0.2, 1) infinite',
      },
    },
    {
      styleRules: ['animate'],
      ...
      values: {
        pulse:
          'pulse calc(2 * var(--default-animation-duration)) cubic-bezier(0.4, 0, 0.6, 1) infinite',
      },
    },
    {
      styleRules: ['animate'],
      keyframes: ['bounce'],
      values: { bounce: 'bounce var(--default-animation-duration) infinite' },
    },
    {
      styleRules: ['animate'],
      keyframes: ['enter'],
      values: { in: 'enter var(--default-animation-duration)' },
    },
    {
      styleRules: ['animate'],
      keyframes: ['exit'],
      values: { out: 'exit var(--default-animation-duration)' },
    },
    {
  ...
  styleRules: {
    ...
    fade: ['--tw-enter-opacity'],
    animationTranslate: ['--animation-enter-translate'],
    spin: ['--animation-enter-rotate'],
    slideTop: ['--animation-enter-translate-y'],
    slideBottom: ['--animation-enter-translate-y'],
    slideLeft: ['--animation-enter-translate-x'],
    slideRight: ['--animation-enter-translate-x'],
    zoom: ['--animation-enter-scale'],
    font: ['font-family'],
    p: ['padding'],
